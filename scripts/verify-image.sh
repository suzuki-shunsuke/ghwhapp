...
IMAGE=ghcr.io/suzuki-shunsuke/ghwhapp:$TAG
docker pull $IMAGE
...
sign_digest=$(cosign verify \
    ...
    --certificate-identity "https://github.com/suzuki-shunsuke/ghwhapp/.github/workflows/release.yaml@refs/tags/$TAG" \
    --certificate-github-workflow-ref "refs/tags/$TAG" \
    --certificate-github-workflow-repository "suzuki-shunsuke/ghwhapp" \
    $IMAGE |
